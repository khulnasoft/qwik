...
[Read the full guide here](https://github.com/KhulnaSoft/qwik/blob/main/starters/adapters/netlify-edge/README.md)
...
import { createQwikCity } from '@khulnasoft.com/qwik-city/middleware/netlify-edge';
...
- [Netlify Edge Middleware Source](https://github.com/KhulnaSoft/qwik/blob/main/packages/qwik-city/src/middleware/netlify-edge/index.ts)
