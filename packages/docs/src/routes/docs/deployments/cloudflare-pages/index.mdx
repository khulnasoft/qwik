...
[Read the full guide here](https://github.com/KhulnaSoft/qwik/tree/main/starters/adapters/cloudflare-pages/README.md)
...
- [Cloudflare Pages Middleware Source](https://github.com/KhulnaSoft/qwik/tree/main/packages/qwik-city/src/middleware/cloudflare-pages/index.ts)
...
import { type PlatformCloudflarePages } from '@khulnasoft.com/qwik-city/middleware/cloudflare-pages';
