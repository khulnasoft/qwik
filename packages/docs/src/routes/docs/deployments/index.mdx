...
- [Adapters Source](https://github.com/KhulnaSoft/qwik/tree/main/packages/qwik-city/adapters)
...
For middleware, you'll notice that each one calls the common `@khulnasoft.com/qwik-city/middleware/request-handler` package. The job of each middleware is to translate the request and response to the standardized format that Qwik City request handler package uses.

- [Middleware Source](https://github.com/KhulnaSoft/qwik/tree/main/packages/qwik-city/middleware)
