...
Typically, package managers install peer dependencies. However, if you get a `Cannot find package '@khulnasoft.com/qwik'` warning when starting Astro, install Qwik.

<PackageManagerTabs>
<span q:slot="pnpm">
```shell
pnpm install @khulnasoft.com/qwik
```
</span>
<span q:slot="npm">
```shell
npm install @khulnasoft.com/qwik
```
</span>
<span q:slot="yarn">
```shell
yarn add @khulnasoft.com/qwik
```
</span>
<span q:slot="bun">
```shell
bun install @khulnasoft.com/qwik
```
</span>
</PackageManagerTabs>
