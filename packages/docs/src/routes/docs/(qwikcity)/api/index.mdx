...
import { component$ } from '@khulnasoft.com/qwik';
import { useNavigate } from '@khulnasoft.com/qwik-city';
...
```tsx
import { component$ } from '@khulnasoft.com/qwik';
import { useNavigate, useLocation } from '@khulnasoft.com/qwik-city';
...
import { QwikCityMockProvider } from '@khulnasoft.com/qwik-city';
