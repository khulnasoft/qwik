...
```tsx
import { component$ } from '@builder.io/qwik';
import { Link, useNavigate } from '@khulnasoft.com/qwik-city';
...
> The `Link` component uses the `useNavigate()` hook [internally](https://github.com/KhulnaSoft/qwik/blob/e452582f4728cbcb7bf85d03293e757302286683/packages/qwik-city/runtime/src/link-component.tsx#L33).
...
```tsx
import { component$ } from '@builder.io/qwik';
import { Link, routeLoader$, useNavigate } from '@khulnasoft.com/qwik-city';
