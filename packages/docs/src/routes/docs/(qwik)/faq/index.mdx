...
```js title="app.js"
import { componentQrl, qrl } from '@khulnasoft.com/qwik';
...
import { jsx as _jsx } from '@khulnasoft.com/qwik/jsx-runtime';
...
Yes, [MIT](https://github.com/KhulnaSoft/qwik/blob/main/LICENSE) and [dependency-free](https://github.com/KhulnaSoft/qwik/blob/main/packages/qwik/package.json), installing Qwik will not bloat your node_modules nor your lawyers.
