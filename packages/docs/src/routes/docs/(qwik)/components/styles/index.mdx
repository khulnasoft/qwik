...
To use scoped CSS, you can use the `useStylesScoped$()` hook exported from `@khulnasoft.com/qwik`.
...
```tsx
import { useStylesScoped$, component$ } from '@khulnasoft.com/qwik';
...
```tsx
import { useStyles$, component$ } from '@khulnasoft.com/qwik';
