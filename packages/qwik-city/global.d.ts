...
declare var QWIK_MANIFEST: import('@khulnasoft.com/qwik/optimizer').QwikManifest | undefined | null;
...
type ExperimentalFeatures = import('@khulnasoft.com/qwik/optimizer').ExperimentalFeatures;
